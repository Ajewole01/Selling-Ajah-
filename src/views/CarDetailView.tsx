      ...
      <div className="min-h-screen bg-[#FAF9F5] dark:bg-[#050505] flex items-center justify-center p-6 text-center">
        <div className="max-w-md">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-full bg-[#D4AF37] text-black font-bold text-xs uppercase tracking-wider shadow-sm font-mono"
          >
            Browse Fleet
          </button>
        </div>
    ...
    <div ref={pageRef} className="sa-detail sa-car-brochure sa-detail--car min-h-screen bg-[#FAF9F5] dark:bg-[#050505] text-neutral-900 dark:text-[#F5F5F0] pb-28 transition-colors duration-200">
      ...
      <div className="border-b border-black/8 dark:border-white/10 bg-white dark:bg-[#080808] py-3.5 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between text-xs text-neutral-600 dark:text-white/60">
          <button
            onClick={() => navigate('/cars')}
            className="flex items-center gap-1 hover:text-[#D4AF37] transition-colors font-mono cursor-pointer"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4 mb-6">
          <div>
            <div className="flex items-center gap-2 mb-2 font-mono">
              <span className="bg-[#D4AF37] text-black text-[10px] font-bold px-3 py-0.5 rounded-full uppercase tracking-wider">
                {vehicle.category}
              </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-10">
            ...
            {/* Quick Specs */}
            <div className="grid grid-cols-3 gap-4 p-5 rounded-2xl bg-white dark:bg-[#111111] border border-black/8 dark:border-white/10 shadow-sm dark:shadow-none">
            ...
            <div className="bg-white dark:bg-[#111111] border border-black/8 dark:border-white/10 rounded-3xl p-6 sm:p-8 shadow-sm dark:shadow-none">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-neutral-700 dark:text-white/70">
                <div className="p-4 bg-neutral-50 dark:bg-[#050505] rounded-xl border border-black/5 dark:border-white/10">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              <div className="bg-white dark:bg-[#111111] border border-black/8 dark:border-white/10 rounded-3xl p-6 sm:p-7 shadow-xl">
                <span className="text-xs text-neutral-500 dark:text-white/50 uppercase tracking-widest block mb-1 font-mono">
                  Daily Rental Rate
                </span>
                <div className="text-3xl font-serif font-bold text-[#D4AF37] mb-4">
                    ...
                    <form onSubmit={handleBookingSubmit} className="space-y-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-neutral-100 dark:bg-[#050505] border border-black/10 dark:border-white/15 rounded-xl px-3 py-2 text-xs text-neutral-900 dark:text-white outline-none focus:border-[#D4AF37]"
                        />
                      </div>
                      ...
                      <label className="flex items-center gap-2.5 p-3 rounded-xl bg-neutral-50 dark:bg-[#050505] border border-black/10 dark:border-white/10 cursor-pointer">
                        <input
                          type="checkbox"
                          checked={withSecurityEscort}
                          onChange={e => setWithSecurityEscort(e.target.checked)}
                          className="w-4 h-4 rounded text-[#D4AF37] bg-white dark:bg-[#111111] border-neutral-300 dark:border-white/20"
                        />
                      ...
                      {/* Pricing Summary */}
                      <div className="p-3.5 bg-neutral-50 dark:bg-[#050505] rounded-xl border border-black/8 dark:border-white/10 text-xs space-y-1">
                        ...
                        <div className="flex justify-between text-neutral-900 dark:text-white font-bold pt-1.5 border-t border-black/8 dark:border-white/10">
                          <span>Total</span>
                          <span className="text-[#D4AF37]">{formatNaira(grandTotal)}</span>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="w-full py-3.5 rounded-full bg-[#D4AF37] hover:bg-[#c49f2f] text-black font-bold text-xs uppercase tracking-wider transition-colors flex items-center justify-center gap-1.5 shadow-md shadow-[#D4AF37]/20 font-mono cursor-pointer"
                      >
