...
export const PropertyCard: React.FC<PropertyCardProps> = ({
  ...
  const statusBadge = () => {
    ...
    if (property.listingType === 'sale') {
      return <span className="bg-[#D4AF37] text-black text-[10px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-wider shadow-sm">For Sale</span>;
    }
    return <span className="bg-[#D4AF37] text-black text-[10px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-wider shadow-sm">For Rent</span>;
  };
      ...
      >
        ...
        <div className="md:w-72 lg:w-80 h-60 md:h-auto relative shrink-0 overflow-hidden bg-neutral-900">
          ...
          <div className="absolute top-3.5 left-3.5 flex items-center gap-2 z-10">
            {statusBadge()}
            {property.isFeatured && (
              <span className="bg-black/75 backdrop-blur-md border border-[#D4AF37]/50 text-[#D4AF37] text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase tracking-widest">
                Featured
              </span>
            )}
          </div>
          ...
          >
            <Heart className={`w-4 h-4 ${liked ? 'text-[#D4AF37] fill-[#D4AF37]' : 'text-white'}`} />
          </button>
        </div>
        ...
        <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between gap-2 mb-2 text-xs text-neutral-500 dark:text-white/50">
              <span className="font-mono text-[#D4AF37] text-[11px] font-bold tracking-wider">{property.refNumber}</span>
            ...
            <h3 className="font-serif text-lg sm:text-xl font-bold text-neutral-900 dark:text-white group-hover:text-[#D4AF37] dark:group-hover:text-[#D4AF37] transition-colors line-clamp-2 mb-2">
              {property.title}
            </h3>
          ...
          <div className="pt-4 border-t border-black/8 dark:border-white/10 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right">
                ...
                <div className="text-lg sm:text-xl font-bold text-[#D4AF37] font-serif">
    ...
    >
      ...
      <div className="relative aspect-[16/10] overflow-hidden bg-neutral-900">
        ...
        <div className="absolute bottom-3.5 left-3.5 right-3.5 flex items-end justify-between z-10">
          <div>
            ...
            <div className="text-lg sm:text-xl font-bold text-[#D4AF37] font-serif tracking-tight drop-shadow-md">
              {formatNaira(property.price)}
              {property.pricePeriod && (
          ...
          <span className="text-[10px] font-mono text-[#D4AF37] bg-black/80 backdrop-blur-md px-2 py-0.5 rounded border border-[#D4AF37]/40">
            {property.refNumber}
          </span>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between">
        <div>
          ...
          <h3 className="font-serif text-base sm:text-lg font-bold text-neutral-900 dark:text-white group-hover:text-[#D4AF37] dark:group-hover:text-[#D4AF37] transition-colors line-clamp-2 mb-2 leading-snug">
            {property.title}
          </h3>
