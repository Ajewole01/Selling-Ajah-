    ...
    >
      ...
      <div className="relative aspect-[16/10] overflow-hidden bg-neutral-900">
        ...
        <div className="absolute top-3.5 left-3.5 flex items-center gap-2">
          <span className="bg-brand-green-primary text-white text-[10px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-wider shadow-sm">
            Serviced Stay
          </span>
        ...
        <div className="absolute bottom-3.5 left-3.5 right-3.5 flex items-end justify-between z-10">
          ...
          <span className="text-[10px] text-brand-green-sage font-semibold bg-black/80 backdrop-blur-md px-2.5 py-0.5 rounded-full border border-brand-green-sage/40 uppercase tracking-wider">
            {apartment.area}
          </span>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between">
        <div>
          <h3 className="font-serif text-lg font-bold text-neutral-900 dark:text-white group-hover:text-brand-green-primary dark:group-hover:text-brand-green-sage transition-colors line-clamp-1 mb-2 leading-snug">
            {apartment.name}
          </h3>
          ...
          <div className="flex flex-wrap gap-1.5 mb-4">
            <span className="text-[10px] bg-black/5 dark:bg-white/5 border border-black/8 dark:border-white/10 text-neutral-700 dark:text-white/70 px-2.5 py-1 rounded-lg flex items-center gap-1.5 font-medium">
              <Users className="w-3 h-3 text-brand-green-primary dark:text-brand-green-sage" /> Up to {apartment.maxGuests} guests
            </span>
            <span className="text-[10px] bg-black/5 dark:bg-white/5 border border-black/8 dark:border-white/10 text-neutral-700 dark:text-white/70 px-2.5 py-1 rounded-lg flex items-center gap-1.5 font-medium">
              <Bed className="w-3 h-3 text-brand-green-primary dark:text-brand-green-sage" /> {apartment.bedrooms} Bedrooms
            </span>
            <span className="text-[10px] bg-black/5 dark:bg-white/5 border border-black/8 dark:border-white/10 text-neutral-700 dark:text-white/70 px-2.5 py-1 rounded-lg flex items-center gap-1.5 font-medium">
              <Wifi className="w-3 h-3 text-brand-green-primary dark:text-brand-green-sage" /> Starlink WiFi
            </span>
          </div>
        </div>
        ...
        <div className="pt-3 border-t border-black/8 dark:border-white/10 flex items-center gap-2">
          <button
            onClick={handleCardClick}
            className="flex-1 py-2 px-3.5 rounded-full bg-neutral-900 text-white hover:bg-brand-green-primary dark:bg-white/10 dark:hover:bg-brand-green-primary dark:hover:text-white text-xs font-semibold flex items-center justify-center gap-1.5 transition-all uppercase tracking-wider group/btn"
          >
